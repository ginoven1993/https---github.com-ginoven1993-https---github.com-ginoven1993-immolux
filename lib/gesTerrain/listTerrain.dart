...
import 'package:immolux_imobilier/gesTerrain/update.dart';
import 'package:immolux_imobilier/gesTerrain/vueterrain.dart';
...
class HomeTerrain extends StatefulWidget {
  @override
  _HomeTerrainState createState() => _HomeTerrainState();
}

class _HomeTerrainState extends State<HomeTerrain> {
  String state = '0';
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ViewTerrain(
                                        ter: ModelTerrain(
                                      id: doc['id'],
                                      description: doc['description'],
                                      typeservice: doc['type_service'],
                                      typeterrain: doc['type'],
                                      nom_proprio: doc['nom_proprio'],
                                      numPT: doc['num_proprio'],
                                      pri: doc['prix'],
