...
class _CreateState extends State<Create> {
  String gainchaleng = 'Urbain';
  var items1 = ['Urbain', 'Agricole'];

  final TextEditingController idT = TextEditingController();
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              TextField(
                decoration: InputDecoration(
                  labelText: "Localisation du terrain",
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                  ),
                ),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        await documents.set({
                          ...
                          "typeTerrain": typT.text,
                          "numéro client": numC.text,
                          "numéro propriétaire": numPT.text,
                          "Prix terrain": priT.text,
                          "localisation terrain": locT.text,
                        });
