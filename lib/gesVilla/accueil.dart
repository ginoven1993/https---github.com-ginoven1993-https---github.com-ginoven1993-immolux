...
import 'package:immolux_imobilier/gesMaison/createMaison.dart';
import 'package:immolux_imobilier/gesVilla/createVilla.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            StreamBuilder(
                stream: state == '1'
                    ? FirebaseFirestore.instance.collection('Villa').snapshots()
                    : state == '2'
