...
class CrudAchat extends StatefulWidget {
  @override
  _CrudAchatState createState() => _CrudAchatState();
}

class _CrudAchatState extends State<CrudAchat> {
  bool isChecked = true;
  ...
  create() async {
    try {
      await firebase.collection("achats").doc(ter.text).set({
        "terrain": ter.text,
  ...
  update() async {
    try {
      await firebase.collection("achats").doc(ter.text).update({
        "terrain": ter.text,
        "Localisation": loc.text,
        "Appartement": apart.text,
  ...
  delete() async {
    try {
      await firebase.collection("achats").doc(ter.text).delete();
    } catch (e) {
      print(e);
    }
  }
