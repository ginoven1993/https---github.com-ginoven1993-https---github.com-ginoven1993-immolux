...
class CrudLocation extends StatefulWidget {
  @override
  _CrudLocationState createState() => _CrudLocationState();
}

class _CrudLocationState extends State<CrudLocation> {
  ...
  create() async {
    try {
      await firebase.collection("locations").doc(ter.text).set({
        "terrain": ter.text,
  ...
  update() async {
    try {
      await firebase.collection("locations").doc(ter.text).update({
        "terrain": ter.text,
        "Localisation": loc.text,
        "Appartement": apart.text,
  ...
  delete() async {
    try {
      await firebase.collection("locations").doc(ter.text).delete();
    } catch (e) {
      print(e);
    }
  }
