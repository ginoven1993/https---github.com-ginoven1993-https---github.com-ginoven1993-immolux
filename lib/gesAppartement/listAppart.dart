...
import 'package:immolux_imobilier/gesAppartement/updateappart.dart';
import 'package:immolux_imobilier/gesAppartement/vueappartement.dart';
import 'package:shimmer/shimmer.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class HomeAppart extends StatefulWidget {
  @override
  _HomeAppartState createState() => _HomeAppartState();
}

class _HomeAppartState extends State<HomeAppart> {
  String state = '0';
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ViewAppart(
                                      apart: ModelAppart(
                                        id: doc['id'],
                                        description: doc['description'],
                                        typeservice: doc['type_service'],
                                        categ: doc['Categorie_Appartement'],
                                        typeappart: doc['type'],
                                        nbrecham: doc['Nombre_de_chambres'],
                                        nom_proprio: doc['nom_proprio'],
                                        num_proprio: doc['num_proprio'],
                                        pri: doc['prix'],
                                        locA: doc['localisation'],
                                        image: doc['image'],
                                      ),
                                    ),
                                  ),
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) => ViewAppart(
                                            apart: ModelAppart(
                                              ...
                                              typeservice: doc['type_service'],
                                              categ:
                                                  doc['Categorie_Appartement'],
                                              typeappart: doc['type'],
                                              nbrecham:
                                                  doc['Nombre_de_chambres'],
                                              nom_proprio: doc['nom_proprio'],
                                              num_proprio: doc['num_proprio'],
                                              pri: doc['prix'],
                                              locA: doc['localisation'],
